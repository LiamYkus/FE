...
import {AddUpdateClassDialog} from "@/sections/class/admin/add-update-class-dialog.jsx";
import {UpdateClassDialog} from "@/sections/class/admin/update-class-dialog.jsx";
import {DeleteClassDialog} from "@/sections/class/admin/delete-class-dialog.jsx";
...
const classListTableData = [
  {
    ...
    subjectCredit: '3',
    practice: 6,
    description: 'A classroom is a space designed for teaching and learning, typically found in educational institutions such as schools, colleges, and universities.',
  },
  {
...
export default function Class() {
  ...
  const [selectedClass, setSelectedClass] = React.useState(null); // Store selected class data

  const navigate = useNavigate();

  const handleUpdateClick = (classData) => {
    console.log('vao day', classData)
  ...
  return (
    <>
            ...
            <table className="w-full min-w-[640px] table-auto">
              ...
              <tbody>
                {classListTableData.map(
                  ({ img, name, practice, start, end, subjectCredit, budget, completion, description }, key) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className={className} onClick={() => handleUpdateClick({ name, start, end, description })}>
                          <div className="flex items-center gap-4">
                            <Typography variant="small" color="blue-gray" className="font-bold">
                              {name}
                            </Typography>
                        ...
                        <td className={className}>
                          <Typography
                            ...
                            className="text-xs font-medium text-blue-gray-600"
                          >
                            {`${description} exerrices`}
                          </Typography>
                        </td>
                        <td>
                          <Button className="flex items-center gap-3" onClick={() => setDele(true)}>
      ...
      <UpdateClassDialog
          ...
          classData={selectedClass} // Pass selected class data
      />
