import { AddUpdateStudentDialog } from '@/sections/student/add-update-student';
import { DeleteStudentDialog } from '@/sections/student/delete-student-dialog';
import { StudentInfoDialog } from '@/sections/student/student-info-dialog';
import {
  ArrowLeftIcon,
  ArrowRightIcon,
  EyeIcon,
    ...
    <>
      <div className="mt-12 flex items-center justify-between ">
        ...
        <div className="flex gap-x-4 sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center">
          ...
          <Button className="flex items-center gap-3" onClick={() => setInvite(true)}>
          ...
          <table className="w-full min-w-[640px] table-auto">
            ...
            <tbody>
              {practiceTableData.map(
                ({ img, name, email, gender, studentCode, phone, role, status, address }, key) => {
      ...
      <DeleteStudentDialog open={dele} handleClose={() => setDele(false)} />
      <AddUpdateStudentDialog open={invite} handleClose={() => setInvite(false)} />

      <StudentInfoDialog open={view} handleClose={() => setView(false)} />
    </>
  );
}
